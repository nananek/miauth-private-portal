...
func newRepos(q querier) domain.Repos {
	return domain.Repos{
		...
		BootstrapGates:  &bootstrapGateRepository{q: q},
		LocalMiAuth:     &localMiAuthSessionRepository{q: q},
		UpstreamMiAuth:  &upstreamMiAuthSessionRepository{q: q},
		APITokens:       &apiTokenRepository{q: q},
		OwnerBindings:   &ownerBindingRepository{q: q},
		UpstreamTokens:  &upstreamTokenRepository{q: q},
